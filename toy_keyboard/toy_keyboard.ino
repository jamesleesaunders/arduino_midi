...
const uint8_t buttons[NUM_BUTTONS] = {button1, button2, button3, button4, button5, button6, button7, button8, button9, button10};
const uint16_t buttonIds[NUM_BUTTONS] = {1, 2, 4, 8, 16, 32, 64, 128, 256, 512};
